...
namespace APIVerve
{
    public class DuckDuckGoSearchAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/duckduckgosearch";
        ...
        public DuckDuckGoSearchAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public DuckDuckGoSearchAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, duckduckgosearchQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(duckduckgosearchQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(duckduckgosearchQueryOptions options)
        {
